package com.kodillam.testing.library;
...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfNoBooks() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user = new LibraryUser("A","B","999");

        List<Book> emptyList = new ArrayList<Book>();
        when(libraryDatabaseMock.listBooksInHandsOf(anyObject())).thenReturn(emptyList);
    ...
    public void testListBooksInHandsOfOneBook() {
        ...
        List<Book> listOfBooksMock = generateListOfNBooks(1);
        when(libraryDatabaseMock.listBooksInHandsOf(anyObject())).thenReturn(listOfBooksMock);
    ...
    public void testListBooksInHandsOfFiveBooks() {
        ...
        List<Book> listOfBooksMock = generateListOfNBooks(5);
        when(libraryDatabaseMock.listBooksInHandsOf(anyObject())).thenReturn(listOfBooksMock);
